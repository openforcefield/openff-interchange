...
def to_gro(openff_sys: System, file_path: Path):
    ...
    with open(file_path, "w") as gro:
        ...
        for idx, atom in enumerate(openff_sys.topology.atoms):  # type: ignore
...
def _write_atomtypes(openff_sys: System, top_file: IO) -> Dict:
    ...
    for atom_idx, atom in enumerate(openff_sys.topology.atoms):  # type: ignore
    ...
    for atom_idx, atom_type in typemap.items():
        atom = openff_sys.topology.atoms[atom_idx]  # type: ignore
