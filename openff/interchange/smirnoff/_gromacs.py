...
def _convert(
    ...
    unique_molecule_map: dict[
        int,
        list,
    ] = interchange._topology.identical_molecule_groups
    ...
    for unique_molecule_index in unique_molecule_map:
        unique_molecule = interchange._topology.molecule(unique_molecule_index)
        ...
        for atom in unique_molecule.atoms:
            ...
            topology_index = interchange._topology.atom_index(atom)
        ...
        for virtual_site_key in molecule_virtual_site_map[interchange._topology.molecule_index(unique_molecule)]:
    ...
    _ordered_molecules = [None] * interchange._topology.n_molecules
    ...
    for unique_molecule_index in unique_molecule_map:
        ...
        for atom in unique_molecule.atoms:
            ...
            charge = _partial_charges[interchange._topology.atom_index(atom)]
...
def _convert_bonds(
    ...
    atom_indices_in_this_molecule = {interchange._topology.atom_index(a) for a in unique_molecule.atoms}
...
def _convert_dihedrals(
    ...
    if improper_torsion_handler:
        ...
        for improper in unique_molecule.smirnoff_impropers:
            topology_indices = tuple(interchange._topology.atom_index(a) for a in improper)
...
def _convert_settles(
    ...
    topology_atom_indices = [interchange._topology.atom_index(atom) for atom in unique_molecule.atoms]
