...
class GROMACSWriter(_BaseModel):
    ...
    def _write_settles(self, top, molecule_type):
        ...
        for settle in molecule_type.settles:
            top.write(
                ...
                f"{function:6d}\t"
                f"{settle.oxygen_hydrogen_distance.m_as('nanometer'):20.12f}\t"
                f"{settle.hydrogen_hydrogen_distance.m_as('nanometer'):20.12f}\n",
            )
    ...
    def _write_gro(self, gro, decimal: int):
        ...
        positions = numpy.round(self.system.positions, decimal).m_as("nanometer")
        ...
        if self.system.box is None:
            ...
            box = self.system.box.m_as("nanometer")
