...
def to_gro(openff_sys: "Interchange", file_path: Union[Path, str], decimal=8):
    ...
    with open(path, "w") as gro:
        ...
        for atom_index, atom in enumerate(openff_sys.topology.atoms):
            ...
            atom_name = typemap[atom_index]
            gmx_atom_index = (atom_index + 1) % 100000
            ...
            gro.write(
                ...
                % (
                    ...
                    atom_name,
                    gmx_atom_index,
                    rounded_positions[atom_index, 0],
                    rounded_positions[atom_index, 1],
                    rounded_positions[atom_index, 2],
                )
            )
