...
def to_gro(openff_sys: "Interchange", file_path: Union[Path, str], decimal=8):
    ...
    # this must be Dict[Molecule, List[VirtualSiteKey]] because one molecule can contain multiple virtual sites
    ...
    if len(virtual_site_map) > 0:
        ...
        for virtual_site, molecule in virtual_site_molecule_map.items():
            molecule_virtual_site_map[molecule].append(virtual_site)
